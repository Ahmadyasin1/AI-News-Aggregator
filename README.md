...
**Student**: Ahmad Yasin (Reg. L1F22BSAI0052)

**Teacher**: Muhammad Rizwan

**Subject**: Generative AI

**Assignment**: AI News Aggregator Project (Assignment 1)
...
**Start FastAPI backend (local):**
```bash
uv run uvicorn app.api:app --host 0.0.0.0 --port 8000
```

**Start React frontend (local):**
```bash
cd frontend
npm install
npm run dev
...
**Run daily pipeline API from frontend:**
